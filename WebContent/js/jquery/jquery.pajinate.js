    ...
    $.fn.pajinate = function(options){
		...
		return this.each(function(){
			...
			var more = '<span class="ellipse more">...</span>',
				...
				first = !options.show_first_last ? '' : '<a class="first_link" href="">'+ options.nav_label_first +'</a>',
				last = !options.show_first_last ? '' : '<a class="last_link" href="">'+ options.nav_label_last +'</a>';
		...
		function movePageNumbersLeft(e, new_p){
			var new_page = new_p,
				$current_active_link = $(e).siblings('.active_page');
